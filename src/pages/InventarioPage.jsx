...
const InventarioPage = () => {
  ...
  // Filtrar inventarios en función del nombre del producto o lote
  const filteredInventarios = inventarios.filter(
    (inventario) =>
      inventario.producto?.nombre.toLowerCase().includes(searchText.toLowerCase()) || // Filtrar por nombre del producto
      inventario.lote?.toLowerCase().includes(searchText.toLowerCase()) // Filtrar por lote
  );
  ...
  return (
    <div>
      ...
      <Table dataSource={filteredInventarios} rowKey="_id">
        <Table.Column 
          title="Producto" 
          dataIndex="producto" 
          key="producto" 
