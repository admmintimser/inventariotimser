...
const navigation = [
  ...
  { name: "Entrada", href: "/purchase-details", current: false },
  { name: "Salidas", href: "/sales", current: false },
  { name: "Almacenes", href: "/manage-store", current: false },
];

const userNavigation = [{ name: "Cerrar Sesión", href: "./login" }];
                    ...
                    <div className="flex-shrink-0">
                      <div className="flex justify-center items-center gap-2">
                        <img
                          ...
                          src={require("../assets/TimserLogo.png")}
                      ...
                      <Menu as="div" className="relative ml-3">
                        <div>
                          <Menu.Button className="flex max-w-xs items-center rounded-full  text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                            ...
                            <img
                              className="h-8 w-8 "
                              src={require("../assets/favicontim.png")}
                              alt="profile"
                            />
                          </Menu.Button>
                        </div>
