...
import { FaTachometerAlt, FaBoxes, FaFileInvoiceDollar, FaStore, FaSignOutAlt, FaCalculator, FaPeopleCarry,  } from "react-icons/fa";
            ...
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/preventix">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">Preventix</span>
                </div>
              </Link>
            </summary>
          </details>
